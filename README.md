...
O trabalho final da disciplina de Linguagens de Programação, turma 2025-2, do curso de Ciência da Computação da UFFS - Campus Chapecó, consiste na escolha de uma funcionalidade para ser implementada no Interpretador do Lambda Cálculo desenvolvido em sala, ou em alguma variação. **Este trabalho deve ser desenvolvido em duplas ou trios.**
...
- Conclusão da implementação dos construtores sintáticos definidos em aula no lexer, parser, typechecker e interpreter.
